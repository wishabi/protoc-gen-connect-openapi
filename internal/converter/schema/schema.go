	...
	for _, field := range fields {
		schema := &base.Schema{
			/*
				...
				properties object. But Readme requires the oneof title property to be at the top level
				otherwise the UI will render the property as "Option 1, Option 2" as oppose to use the
